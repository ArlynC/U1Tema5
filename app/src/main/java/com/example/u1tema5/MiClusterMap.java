...
public class MiClusterMap extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
    GoogleMap mapa;
    ClusterManager<MiClusterItem> miClusterItemClusterManager;
    ...
    public void onMapClick(LatLng latLng) {
        if (miClusterItemClusterManager == null)
            miClusterItemClusterManager = new ClusterManager<MiClusterItem>(this, mapa);//construccion de clusteritemmanager
        ...
        miClusterItemClusterManager.cluster();//se ejecuta el marcador del cluster
    }
}
