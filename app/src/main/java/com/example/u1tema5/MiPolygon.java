...
public class MiPolygon extends AppCompatActivity implements OnMapReadyCallback, SeekBar.OnSeekBarChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btndibujar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!latLngList.isEmpty()) {
                    ...
                    polygon = gMap.addPolygon(polygonOptions); //se añade al mapa
                    polygon.setStrokeColor(Color.rgb(rojo, verde, azul));//configurar colores de la linea
                    if (checkpintar.isChecked())
                        polygon.setFillColor(Color.rgb(rojo, verde, azul));//para pintar el poligono
                }
            }
        });
        btnlimpiar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(polygon!=null) polygon.remove();
                for(Marker marker: markerList) marker.remove();//elimina marcadores del mapa
                latLngList.clear();
                markerList.clear();//elimina el arraylist que esta en el mapa
